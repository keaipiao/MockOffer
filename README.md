...
**面向求职者的全流程 AI 闭环平台 · The all-in-one AI job-hunting platform**
...
[官网 mockoffer.com](https://mockoffer.com) · [中文](#中文) · [English](#english)
...
打开 http://localhost:3000 （后端 http://localhost:8080，MinIO 控制台 http://localhost:9001）。
...
Open http://localhost:3000. Stop with `make down`.
